...
/** React 课站独立 storage，避免与其他 learning-* 冲突 */
export const CTP_STORAGE_KEY = "react-learn-ctp-flavor";
export const CTP_ACCENT_KEY = "react-learn-ctp-accent";
export const DEFAULT_CTP_FLAVOR: CtpFlavor = "mocha";
/** 默认 Green，贴合 React 青蓝 */
