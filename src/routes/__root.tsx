...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "React 实战学习 v6 · 系统路径",
      },
      {
        name: "description",
        content:
          "React 中文交互教程：对齐 react.dev/llms.txt：路径、文档地图、源码=组件 Demo、测验与全栈工坊。",
      },
    ],
    links: [
...
const CTP_BOOT =
  "(function(){try{var f=localStorage.getItem('react-learn-ctp-flavor');var a=localStorage.getItem('react-learn-ctp-accent');var okF=['mocha','macchiato','frappe','latte'];var okA=['green','mauve','blue','lavender','sapphire','teal','peach','pink'];if(okF.indexOf(f)<0)f='mocha';if(okA.indexOf(a)<0)a='sapphire';document.documentElement.setAttribute('data-ctp-flavor',f);document.documentElement.setAttribute('data-ctp-accent',a);}catch(e){document.documentElement.setAttribute('data-ctp-flavor','mocha');document.documentElement.setAttribute('data-ctp-accent','sapphire');}})();";
